 ...
 *
 * @see \SimpleSAML\Module\core\Auth\Process\AttributeAlter
 */
class AttributeAlterCallback extends \SimpleSAML\Auth\ProcessingFilter
{
    /**
            ...
            foreach ($attributes[$this->subject] as &$value) {
                ...
                if (preg_match($this->pattern, $value, $matches) > 0) {
                    ...
                    if ($this->replacement !== false) {
                        ...
                        $new_value = call_user_func($this->callback, $new_value);
                    }
